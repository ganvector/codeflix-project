...
public record UpdateVideoCommand(
    ...
    public static UpdateVideoCommand with(
        ...
        return new UpdateVideoCommand(id, title, description, launchedAt, duration, opened, published, rating, categories, genres, castMembers, video, trailer, banner, thumbnail, thumbnailHalf);
    }
}