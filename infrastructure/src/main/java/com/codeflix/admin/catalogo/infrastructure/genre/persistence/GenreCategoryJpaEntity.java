...
public class GenreCategoryJpaEntity {
    ...
    private GenreCategoryJpaEntity(final GenreJpaEntity aGenre, final CategoryID aCategoryId) {
        this.id = GenreCategoryID.create(aGenre.getId(), aCategoryId.getValue());
        this.genre = aGenre;
    }

    public static GenreCategoryJpaEntity create(final GenreJpaEntity aGenre, final CategoryID aCategoryId) {
