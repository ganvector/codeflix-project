...
public class GenreResponseTest {
    ...
    public void testUnmarshall() throws Exception {
        ...
        """.formatted(expectedId, expectedName, expectedCategories, expectedIsActive, expectedCreatedAt.toString(), expectedUpdatedAt.toString(), expectedDeletedAt.toString());
